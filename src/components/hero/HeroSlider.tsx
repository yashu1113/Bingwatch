...
export const HeroSlider = ({ items }: HeroSliderProps) => {
  ...
  const [autoplayTrailers, setAutoplayTrailers] = useLocalStorage(
    "autoplayTrailers",
    true
  );
  ...
  const toggleAutoplay = useCallback(() => {
    ...
    toast({
      ...
      description: `Trailer autoplay has been ${
  ...
  return (
    <div
      className="relative w-full h-[40vh] md:h-[60vh] lg:h-[80vh] overflow-hidden"
        ...
        <div className="flex h-full w-full">
          {limitedItems.map((item, index) => (
            ...
            >
              ...
              <HeroContent item={item} handleAddToWatchlist={handleAddToWatchlist} />
            </div>
          ))}
        </div>
      </div>
